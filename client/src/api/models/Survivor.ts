...
export function SurvivorFromJSONTyped(json: any, ignoreDiscriminator: boolean): Survivor {
    if (json == null) {
        return json;
    }
    return {
...
export function SurvivorToJSONTyped(value?: Survivor | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
